...
module "public_load_balancer" {
  ...
  count                          = var.provision_scale_set != true ? (var.provision_public_load_balancer == true ? 1 : 0) : 0
  source                         = "github.com/wesley-trust/tfsubmodule-public_load_balancer?ref=v1-public_load_balancer"
